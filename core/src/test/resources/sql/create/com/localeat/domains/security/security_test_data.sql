...
insert into users (username, password, enabled) values ('virginie', '$2a$10$GAFeu1ig0iTKUXM3nNVuCevYrmPrK2Vh4wosSr5TzqODJ7tsujDKW', true); --1501
insert into authorities (username, authority) values ('virginie', 'CUSTOMER');
insert into accounts (id, username, actor_id) values (3, 'virginie', 3);

insert into users (username, password, enabled) values ('jerome', '$2a$10$Y3xy/sKEG4gzkM9.L3YbR.egYLJ300vzJx9h00KtYOzemWX.OMTem', true);  --0607
insert into authorities (username, authority) values ('jerome', 'CUSTOMER');
insert into accounts (id, username, actor_id) values (4, 'jerome', 4);